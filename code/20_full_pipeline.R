...
cat("Step 5: defer GO and KEGG to the unified recomputation step\n")
writeLines(
  c(
    "Enrichment is computed after the fresh differential-expression tables are written.",
    "The canonical project results are generated/12_enrichment_recomputed/.",
    "Pathway results are generated by the enrichment stage after differential expression."
  ),
  file.path(out_root, "04_enrichment", "README.txt")
)
